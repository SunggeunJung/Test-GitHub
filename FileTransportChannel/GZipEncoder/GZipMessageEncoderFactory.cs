...
namespace Microsoft.ServiceModel.Samples
{
    ...
    internal class GZipMessageEncoderFactory : MessageEncoderFactory
    {
        ...
        class GZipMessageEncoder : MessageEncoder
        {
            ...
            //This implementation wraps an inner encoder that actually 
            // converts a WCF Message into textual XML, binary XML or 
            // some other format. This implementation then compresses 
            // the results. The opposite happens when reading messages.
            ...
            static ArraySegment<byte> CompressBuffer
                ...
                (ArraySegment<byte> buffer, BufferManager bufferManager, string contentType)
            {
                ...
                Message returnMessage = innerEncoder.ReadMessage
                    (decompressedBuffer, bufferManager);
            ...
            public override void WriteMessage(Message message, System.IO.Stream stream)
            {
                ...
                // innerEncoder.WriteMessage(message, gzStream) depends 
                // on that it can flush data by flushing the stream passed in, 
                // but the implementation of GZipStream.Flush will not flush underlying
